      ...
      <Form layout="vertical" className='bg-white !p-3 rounded' onFinish={onFinish}>
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className=" flex justify-n gap-3 ">
            < Button type="primary" htmlType="submit" className='w-50' onClick={() => navigate("/admin/products")}>Create Product</Button>
            <Button type="primary" htmlType="submit" className='w-50' onClick={() => navigate("/admin/products")}>Cancel</Button>
